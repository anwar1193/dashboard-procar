		...
		Highcharts.chart('portfolio-sales', {
			...
			series: [{
				...
				data: [
					...
					// sales tahun ini
					$query_sales = "SELECT SUM(IF( Bulan = 01 AND Tahun = '$tahun_now', TotalPenjualan, 0)) AS penjualan_1,
			...
			series: [{
				...
				data: [
					<?php
						...
						$q_coll_naspers = "SELECT * FROM tbl_coll_nas WHERE cabang='TOTAL' AND tahun='$tahun_now'";
						$r_coll_naspers = mysqli_query($koneksi,$q_coll_naspers) or die ('error coll nas2');
						$row_coll_naspers = mysqli_fetch_assoc($r_coll_naspers);
						
						if($row_coll_naspers['pers_1'] == 0){
							if($bulan_now == '01'){
							...
							echo $row_coll_naspers['pers_1'].',';
						}


						if($row_coll_naspers['pers_2'] == 0){
							if($bulan_now == '02'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_2'].',';
						}


						if($row_coll_naspers['pers_3'] == 0){
							if($bulan_now == '03'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_3'].',';
						}


						if($row_coll_naspers['pers_4'] == 0){
							if($bulan_now == '04'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_4'].',';
						}


						if($row_coll_naspers['pers_5'] == 0){
							if($bulan_now == '05'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_5'].',';
						}


						if($row_coll_naspers['pers_6'] == 0){
							if($bulan_now == '06'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_6'].',';
						}


						if($row_coll_naspers['pers_7'] == 0){
							if($bulan_now == '07'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_7'].',';
						}


						if($row_coll_naspers['pers_8'] == 0){
							if($bulan_now == '08'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_8'].',';
						}


						if($row_coll_naspers['pers_9'] == 0){
							if($bulan_now == '09'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_9'].',';
						}


						if($row_coll_naspers['pers_10'] == 0){
							if($bulan_now == '10'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_10'].',';
						}


						if($row_coll_naspers['pers_11'] == 0){
							if($bulan_now == '11'){
								echo substr($persentase_collection, 0,4).',';
							}else{
								echo '0'.',';
							...
							echo $row_coll_naspers['pers_11'].',';
						}


						if($row_coll_naspers['pers_12'] == 0){
							if($bulan_now == '12'){
								echo substr($persentase_collection, 0,4);
							}else{
								echo '0';
