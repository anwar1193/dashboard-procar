				...
				data: [ 
				  ...
				  <?php
					...
					$query = "SELECT Surveyor,
										SUM(IF( Bulan = 03, TotalPenjualan, 0)) AS penjualan
										FROM tbl_sales_surveyor WHERE BranchName=$cabang AND Bulan = 03 AND Tahun = $tahun_now
										GROUP BY Surveyor";
				...
				data: [ 
				  ...
				  <?php
					...
					$query = "SELECT DealerName,
										SUM(IF( Bulan = 03, TotalPenjualan, 0)) AS penjualan
										FROM tbl_sales_dealer WHERE BranchName=$cabang AND Bulan = 03 AND Tahun=$tahun_now
										GROUP BY DealerName";
					$result = mysqli_query($koneksi,$query) or die ('error fungsi');
				...
				data: [ 
				  ...
				  <?php
					...
					$query = "SELECT TahunKendaraan,
										SUM(IF( Bulan = 03, TotalPenjualan, 0)) AS penjualan
										FROM tbl_sales_thnkendaraan WHERE BranchName=$cabang AND Bulan = 03 AND Tahun=$tahun_now
				...
				data: [ 
				  ...
				  <?php
					...
					$query = "SELECT MerkName,
										SUM(IF( Bulan = 03, TotalPenjualan, 0)) AS penjualan
										FROM tbl_sales_merk WHERE BranchName=$cabang AND Bulan = 03 AND Tahun=$tahun_now
										GROUP BY MerkName";
					$result = mysqli_query($koneksi,$query) or die ('error fungsi');
			...
			series: [{  
				...
				data: [ 
				  ...
				  <?php
					...
					$query = "SELECT Tenor,
										SUM(IF( Bulan = 03, TotalPenjualan, 0)) AS penjualan
										FROM tbl_sales_tenor WHERE BranchName=$cabang AND Bulan = 03 AND Tahun=$tahun_now
										GROUP BY Tenor";
					$result = mysqli_query($koneksi,$query) or die ('error fungsi');
			...
			series: [{  
				...
				data: [ 
				  ...
				  <?php
					...
					$query = "SELECT DPPct,
										SUM(IF( Bulan = 03, TotalPenjualan, 0)) AS penjualan
										FROM tbl_sales_dp WHERE BranchName=$cabang AND Bulan = 03 AND Tahun=$tahun_now
										GROUP BY DPPct";
					$result = mysqli_query($koneksi,$query) or die ('error fungsi');
...
<div class="chit-chat-layer1">
	<div class="col-md-12 chit-chat-layer1-left">
			   <div class="work-progres">
					   ...
					   <br />
					   <h4 align="center">Data Penjualan Cabang <?php echo $cabang; ?> Maret <?php echo $tahun_now; ?></h4><br /><br /><br />
